...
SP_TO_PPFD_PACKAGE = os.path.join(_PROJECT_ROOT, "Tool", "Model", "SPtoPPFD", "model", "best_model_package.joblib")
...
class LEDPlant:
    ...
    def __init__(
        ...
        print(f"🌱 Growpod LEDPlant 初始化完成 (控制量=PPFD, target={self.target_ppfd})")
    ...
    def spectrum_to_ppfd(self, spectrum_dict):
        ...
        try:
            ...
            return float(self.sp_pipeline.predict(X)[0])
        except Exception as e:
